...
import { Clock, Fuel, ArrowRight } from "lucide-react";
...
export function RoutePreview({ route }: RoutePreviewProps) {
    // Handle both Route (multiple steps) and LiFiStep (single quote)
    ...
    // Get amounts from step estimate (works for both types)
